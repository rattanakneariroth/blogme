...
export default function Pagination() {
  ...
  return (
    ...
    <nav aria-label="Page navigation example" className="flex justify-center items-center py-8">
        <ul className="inline-flex items-center -space-x-px">
            ...
            <li>
                <a href="#" className="z-10 px-3 py-2 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                    1
                </a>
            </li>
            <li>
